                ...
                <div class="modal-product-info flex-col flex md:flex-row align-middle justify-between">
                    <div class="img-box flex justify-center items-center relative h-auto w-full bg-[#F5F8FF]">
                        <div class="product-img p-8">
                            <img class="object-cover w-auto rounded-t-lg h-auto mx-auto" src="@/assets/img/products/nintendo-switch-oled.png"
                                alt="image">
                        </div>
                    ...
                    <div class="product-details-s w-full pl-5">
                        <h3 class="text-[#2B313B] font-bold text-xl mb-3">{{ name }}</h3>
                        <div class="rating-area flex align-middle justify-between md:justify-start mb-5">
                            <div class=" flex flex-col items-start md:flex-row md:items-center">                           
                                ...
                                <span class="total-review text-xs text[#6C7A93] font-normal ml-0 mt-2 md:mt-0 md:ml-2">(10089 Reviews)</span>
                            </div>
                            <span class="product-status flex items-center text-[#1D9E54] font-normal text-xs ml-1"><img src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon"> -24% (Price Drop)</span>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="flex flex-row items-center justify-start">
                                <div class="flex justify-center mr-3">
                                    ...
                                    <label for="inline-radio"  class="outline-btn btn-translate-z flex justify-center w-28 bg-[#0052fe] text-white text-xs font-bold py-2.5 px-6 transition-all cursor-pointer">Blue Red</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="inline-2-radio" type="radio" value="" name="inline-radio-group"
                                        class="hidden text-blue-600 bg-gray-100 border-gray-300 focus:ring-none focus:none radio-btn">
                                        <label for="inline-2-radio" class="outline-btn btn-translate-z flex w-fit bg-[#0052fe] text-white text-xs font-bold py-2.5 px-6 transition-all cursor-pointer">Red Blue</label>
                                </div>
                            </div>
                        </div>
                        <div class="sm-note text-[#6C7A93] text-sm font-normal my-4 leading-6">
                            Compare prices for Nintendo Switch - OLED model - White from €309.99to €564from 8 stores on Black Friday. The lowest price for the Nintendo Switch - OLED model - White can be found at Nedgame.
                        </div>
                        <div class="brand-list-wrapper rounded-md border border-[#F5F8FF] bg-white">
                            <div class="brands-s flex items-center justify-between py-4 px-3 border-b border-[#F5F8FF]">
                                ...
                                <div class="">
                                    <div class="price flex items-center align-bottom">
                                        ...
                                        <span class="original-price line-through text-[#6C7A93] text-xs font-normal">$290</span>
                                    </div>
                            ...
                            <div class="brands-s flex items-center justify-between py-4 px-3 border-b border-[#F5F8FF]">
                                <div class="modal-brand-logo flex h-4 w-auto">
                                    <img src="@/assets/img/providers/amazon.png" class="w-full h-auto" alt="logo">
                                </div>
                                <div class="">
                                    <div class="price flex items-center align-bottom">
                                        <span class="price text-[#2B313B] text-base font-black ">$250</span> 
                        ...
                        <div class="show-more-price flex items-center justify-center md:justify-start mt-5">
                            <a href="" class="text-[#112954] text-sm font-bold flex items-center">Show all prices <svg width="17" height="16" viewBox="0 0 17 16" class="ml-2" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M4.73431 5.83441C5.04673 5.52199 5.55327 5.52199 5.86569 5.83441L8.5 8.46873L11.1343 5.83441C11.4467 5.52199 11.9533 5.52199 12.2657 5.83441C12.5781 6.14683 12.5781 6.65336 12.2657 6.96578L9.06569 10.1658C8.75327 10.4782 8.24673 10.4782 7.93431 10.1658L4.73431 6.96578C4.4219 6.65336 4.4219 6.14683 4.73431 5.83441Z" fill="#112954"/>
</svg>
</a><span class="price-list-count bg-[#0052FE] text-white text-[8px] font-bold w-[18px] h-[18px] flex items-center justify-center">+4</span>
                        </div>
                    </div>
                </div>
                <div class="filter-options mt-8 md:mt-16 mb-8">
                    <div class="justify-between gap-6 grid grid-cols-2 lg:grid-cols-5">
                        <a class="service-btn flex flex-col md:flex-row border border-[#F5F8FF] items-start md:items-center bg-white text-[#2B313B] grow w-full  text-sm font-semibold p-[17px] rounded-md hover:text-[#135FFF]" href="">Praise</a>
                        <a class="service-btn lg:mx-auto flex flex-col md:flex-row border border-[#F5F8FF] items-start md:items-center bg-white text-[#2B313B] grow w-full  text-sm font-semibold p-[17px] rounded-md hover:text-[#135FFF]" href="">Product information</a>
                        <a class="service-btn flex flex-col md:flex-row border border-[#F5F8FF] items-start md:items-center bg-white text-[#2B313B] grow w-full  text-sm font-semibold p-[17px] rounded-md hover:text-[#135FFF]" href="">Specifications</a>
                        
                        <a class="service-btn flex flex-col md:flex-row border border-[#F5F8FF] items-start md:items-center bg-white text-[#2B313B] grow w-full  text-sm font-semibold p-[17px] rounded-md hover:text-[#135FFF]" href="/car-insurance">FAQ</a>
                        <a class="service-btn lg:mx-auto col-span-2 md:col-span-1 flex flex-col md:flex-row border border-[#F5F8FF] items-start md:items-center bg-white text-[#2B313B] grow w-full  text-sm font-semibold p-[17px] rounded-md hover:text-[#135FFF]" href="">Similar Products</a>                        
                    </div>
                </div>
                    ...
                    <div class="offer-product-list mt-7">
                        <div class="offer-list-inner">
                            <table class="table-auto w-full">
                                ...
                                <tbody>
                                    <tr class="brands-s border-b border-[#F5F8FF]">
                                        <td class="py-4 px-3 "><div class="modal-brand-logo flex h-4 w-auto"><img src="@/assets/img/providers/bol.com-big.png" class="w-auto h-auto" alt="logo"></div></td>
                                        <td><div class="price flex items-center justify-start">
                                            <span class="price text-[#2B313B] text-base font-black">$250</span>
                                            <span class="original-price line-through text-[#6C7A93] text-xs ml-2 mr-4 font-normal">$290</span>
                                            <span class="product-status hidden md:flex items-center text-[#1D9E54] font-normal text-xs"><img src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon"> -24% (Price Drop)</span></div>
                                            <div class="shipping md:hidden block text-xs text-[#26BA65] font-bold"> Free Shipping </div>
                                        </td>
                                        <td>
                                            <div class="condition text-[#6C7A93] text-xs py-4 font-normal pr-6"> New </div>
                                        </td>
...
<path d="M4.13024 0.533001C4.51342 -0.142374 5.48658 -0.142372 5.86976 0.533003L6.68731 1.97396C6.82975 2.22503 7.07373 2.40229 7.35653 2.46018L8.9796 2.79243C9.74033 2.94815 10.041 3.87369 9.51714 4.44682L8.39934 5.66963C8.20458 5.88268 8.11139 6.1695 8.14372 6.45634L8.32929 8.10264C8.41626 8.87426 7.62896 9.44627 6.92198 9.12511L5.4136 8.43989C5.15079 8.3205 4.84921 8.3205 4.5864 8.43989L3.07802 9.12511C2.37104 9.44627 1.58374 8.87426 1.67071 8.10264L1.85628 6.45634C1.88861 6.1695 1.79542 5.88268 1.60066 5.66963L0.48286 4.44682C-0.0410503 3.87369 0.259676 2.94815 1.02041 2.79243L2.64348 2.46018C2.92627 2.40229 3.17025 2.22503 3.31269 1.97396L4.13024 0.533001Z" fill="#A4BCE6"/>
</svg>

                                            <span class="review-status text-xs text-[#2B313B] font-bold ml-2">4</span>
                                        </div>
                                            <span class="total-review text-[10px] text[#6C7A93] font-normal">(10089 Reviews)</span>
                                            </td>
                                        <td class="py-4 pr-3">
                                            <div class="flex items-center justify-between ">
                                                <div class="shipping hidden md:inline-block text-xs text-[#26BA65] font-bold"> Free Shipping </div>
                                                <a href="#" class="bg-[#112954] w-8 h-8 rounded-full flex items-center justify-center"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.83392 11.7657C5.5215 11.4533 5.5215 10.9467 5.83392 10.6343L8.46824 8L5.83392 5.36569C5.5215 5.05327 5.5215 4.54673 5.83392 4.23431C6.14634 3.9219 6.65288 3.9219 6.96529 4.23431L10.1653 7.43431C10.4777 7.74673 10.4777 8.25327 10.1653 8.56569L6.9653 11.7657C6.65288 12.0781 6.14634 12.0781 5.83392 11.7657Z" fill="white"></path></svg></a>
                                            </div>
                                        </td>
                                       
                                    </tr>
                                    <tr class="brands-s border-b border-[#F5F8FF]">
                                        <td class="py-4 px-3 "><div class="modal-brand-logo flex h-4 w-auto"><img src="@/assets/img/providers/media_mart.png" class="w-auto h-auto" alt="logo"></div></td>
                                        <td><div class="price flex items-center justify-start">
                                            <span class="price text-[#2B313B] text-base font-black">$250</span>
                                            <span class="original-price line-through text-[#6C7A93] text-xs ml-2 mr-4 font-normal">$290</span>
                                            <span class="product-status hidden md:flex items-center text-[#1D9E54] font-normal text-xs"><img src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon"> -24% (Price Drop)</span></div>
...
<path d="M4.13024 0.533001C4.51342 -0.142374 5.48658 -0.142372 5.86976 0.533003L6.68731 1.97396C6.82975 2.22503 7.07373 2.40229 7.35653 2.46018L8.9796 2.79243C9.74033 2.94815 10.041 3.87369 9.51714 4.44682L8.39934 5.66963C8.20458 5.88268 8.11139 6.1695 8.14372 6.45634L8.32929 8.10264C8.41626 8.87426 7.62896 9.44627 6.92198 9.12511L5.4136 8.43989C5.15079 8.3205 4.84921 8.3205 4.5864 8.43989L3.07802 9.12511C2.37104 9.44627 1.58374 8.87426 1.67071 8.10264L1.85628 6.45634C1.88861 6.1695 1.79542 5.88268 1.60066 5.66963L0.48286 4.44682C-0.0410503 3.87369 0.259676 2.94815 1.02041 2.79243L2.64348 2.46018C2.92627 2.40229 3.17025 2.22503 3.31269 1.97396L4.13024 0.533001Z" fill="#EFBC21"/>
                                            ...
                                            <span class="review-status text-xs text-[#2B313B] font-bold ml-2">5</span>
                                        </div>
                                            <span class="total-review text-[10px] text[#6C7A93] font-normal">(10089 Reviews)</span>
                                            </td>
                                        <td class="py-4 pr-3">
                                    ...
                                    <tr class="stock-out brands-s border-b border-[#F5F8FF]">
                                        <td class="py-4 px-3 "><div class="modal-brand-logo flex h-4 w-auto"><img src="@/assets/img/providers/bcc.png" class="w-auto h-auto" alt="logo"></div></td>
                                        <td><div class="price flex items-center justify-start">
                                            <span class="price text-[#2B313B] text-base font-black">$250</span>
                                            <span class="original-price line-through text-[#6C7A93] text-xs ml-2 mr-4 font-normal">$290</span>
                                            <span class="product-status hidden md:flex items-center text-[#1D9E54] font-normal text-xs"><img src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon"> -24% (Price Drop)</span></div>
                                            <div class="shipping md:hidden block text-xs text-[#F22222] font-bold"> Out of Stock </div>
                                        </td>
                                        <td>
                                            <div class="condition text-[#6C7A93] text-xs py-4 font-normal pr-6"> New </div>
                                        </td>
...
<path d="M4.13024 0.533001C4.51342 -0.142374 5.48658 -0.142372 5.86976 0.533003L6.68731 1.97396C6.82975 2.22503 7.07373 2.40229 7.35653 2.46018L8.9796 2.79243C9.74033 2.94815 10.041 3.87369 9.51714 4.44682L8.39934 5.66963C8.20458 5.88268 8.11139 6.1695 8.14372 6.45634L8.32929 8.10264C8.41626 8.87426 7.62896 9.44627 6.92198 9.12511L5.4136 8.43989C5.15079 8.3205 4.84921 8.3205 4.5864 8.43989L3.07802 9.12511C2.37104 9.44627 1.58374 8.87426 1.67071 8.10264L1.85628 6.45634C1.88861 6.1695 1.79542 5.88268 1.60066 5.66963L0.48286 4.44682C-0.0410503 3.87369 0.259676 2.94815 1.02041 2.79243L2.64348 2.46018C2.92627 2.40229 3.17025 2.22503 3.31269 1.97396L4.13024 0.533001Z" fill="#A4BCE6"/>
                                        ...
                                        <td class="py-4 pr-3">
                                            <div class="flex items-center justify-between ">
                                                <div class="shipping hidden md:inline-block text-xs text-[#F22222] font-bold"> Out of Stock </div>
                                                <a href="#" class="bg-[#112954] w-8 h-8 rounded-full flex items-center justify-center"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.83392 11.7657C5.5215 11.4533 5.5215 10.9467 5.83392 10.6343L8.46824 8L5.83392 5.36569C5.5215 5.05327 5.5215 4.54673 5.83392 4.23431C6.14634 3.9219 6.65288 3.9219 6.96529 4.23431L10.1653 7.43431C10.4777 7.74673 10.4777 8.25327 10.1653 8.56569L6.9653 11.7657C6.65288 12.0781 6.14634 12.0781 5.83392 11.7657Z" fill="white"></path></svg></a>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="stock-out brands-s border-b border-[#F5F8FF]">
                                        <td class="py-4 px-3 "><div class="modal-brand-logo flex h-4 w-auto"><img src="@/assets/img/providers/art_craft.png" class="w-auto h-auto" alt="logo"></div></td>
                                        <td><div class="price flex items-center justify-start">
                                            <span class="price text-[#2B313B] text-base font-black">$250</span>
                                            <span class="original-price line-through text-[#6C7A93] text-xs ml-2 mr-4 font-normal">$290</span>
                                            <span class="product-status hidden md:flex items-center text-[#1D9E54] font-normal text-xs"><img src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon"> -24% (Price Drop)</span></div>
                                        ...
                                        <td class="hidden md:table-cell"><div class="rating-area flex items-center justify-start">
                                                <svg width="10" height="10" viewBox="0 0 10 10" class="mr-1" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4.13024 0.533001C4.51342 -0.142374 5.48658 -0.142372 5.86976 0.533003L6.68731 1.97396C6.82975 2.22503 7.07373 2.40229 7.35653 2.46018L8.9796 2.79243C9.74033 2.94815 10.041 3.87369 9.51714 4.44682L8.39934 5.66963C8.20458 5.88268 8.11139 6.1695 8.14372 6.45634L8.32929 8.10264C8.41626 8.87426 7.62896 9.44627 6.92198 9.12511L5.4136 8.43989C5.15079 8.3205 4.84921 8.3205 4.5864 8.43989L3.07802 9.12511C2.37104 9.44627 1.58374 8.87426 1.67071 8.10264L1.85628 6.45634C1.88861 6.1695 1.79542 5.88268 1.60066 5.66963L0.48286 4.44682C-0.0410503 3.87369 0.259676 2.94815 1.02041 2.79243L2.64348 2.46018C2.92627 2.40229 3.17025 2.22503 3.31269 1.97396L4.13024 0.533001Z" fill="#EFBC21"/>
                                                </svg>
                                                <svg width="10" height="10" viewBox="0 0 10 10" class="mr-1" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M4.13024 0.533001C4.51342 -0.142374 5.48658 -0.142372 5.86976 0.533003L6.68731 1.97396C6.82975 2.22503 7.07373 2.40229 7.35653 2.46018L8.9796 2.79243C9.74033 2.94815 10.041 3.87369 9.51714 4.44682L8.39934 5.66963C8.20458 5.88268 8.11139 6.1695 8.14372 6.45634L8.32929 8.10264C8.41626 8.87426 7.62896 9.44627 6.92198 9.12511L5.4136 8.43989C5.15079 8.3205 4.84921 8.3205 4.5864 8.43989L3.07802 9.12511C2.37104 9.44627 1.58374 8.87426 1.67071 8.10264L1.85628 6.45634C1.88861 6.1695 1.79542 5.88268 1.60066 5.66963L0.48286 4.44682C-0.0410503 3.87369 0.259676 2.94815 1.02041 2.79243L2.64348 2.46018C2.92627 2.40229 3.17025 2.22503 3.31269 1.97396L4.13024 0.533001Z" fill="#A4BCE6"/>
                                    ...
                                    <tr class="brands-s border-b border-[#F5F8FF]">
                                        <td class="py-4 px-3 "><div class="modal-brand-logo flex h-4 w-auto"><img src="@/assets/img/providers/nedgame.png" class="w-auto h-auto" alt="logo"></div></td>
                                        <td><div class="price flex items-center justify-start">
                                            <span class="price text-[#2B313B] text-base font-black">$250</span>
                                            <span class="original-price line-through text-[#6C7A93] text-xs ml-2 mr-4 font-normal">$290</span>
                                            <span class="product-status hidden md:flex items-center text-[#1D9E54] font-normal text-xs"><img src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon"> -24% (Price Drop)</span></div>
...
<path d="M4.13024 0.533001C4.51342 -0.142374 5.48658 -0.142372 5.86976 0.533003L6.68731 1.97396C6.82975 2.22503 7.07373 2.40229 7.35653 2.46018L8.9796 2.79243C9.74033 2.94815 10.041 3.87369 9.51714 4.44682L8.39934 5.66963C8.20458 5.88268 8.11139 6.1695 8.14372 6.45634L8.32929 8.10264C8.41626 8.87426 7.62896 9.44627 6.92198 9.12511L5.4136 8.43989C5.15079 8.3205 4.84921 8.3205 4.5864 8.43989L3.07802 9.12511C2.37104 9.44627 1.58374 8.87426 1.67071 8.10264L1.85628 6.45634C1.88861 6.1695 1.79542 5.88268 1.60066 5.66963L0.48286 4.44682C-0.0410503 3.87369 0.259676 2.94815 1.02041 2.79243L2.64348 2.46018C2.92627 2.40229 3.17025 2.22503 3.31269 1.97396L4.13024 0.533001Z" fill="#A4BCE6"/>
                                    ...
                                    <tr class="brands-s border-b border-[#F5F8FF]">
                                        <td class="py-4 px-3 "><div class="modal-brand-logo flex h-4 w-auto"><img src="@/assets/img/providers/amazon.png" class="w-auto h-auto" alt="logo"></div></td>
                                        <td><div class="price flex items-center justify-start">
                                            <span class="price text-[#2B313B] text-base font-black">$250</span>
                                            <span class="original-price line-through text-[#6C7A93] text-xs ml-2 mr-4 font-normal">$290</span>
                                            <span class="product-status hidden md:flex items-center text-[#1D9E54] font-normal text-xs"><img src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon"> -24% (Price Drop)</span></div>
...
<path d="M4.13024 0.533001C4.51342 -0.142374 5.48658 -0.142372 5.86976 0.533003L6.68731 1.97396C6.82975 2.22503 7.07373 2.40229 7.35653 2.46018L8.9796 2.79243C9.74033 2.94815 10.041 3.87369 9.51714 4.44682L8.39934 5.66963C8.20458 5.88268 8.11139 6.1695 8.14372 6.45634L8.32929 8.10264C8.41626 8.87426 7.62896 9.44627 6.92198 9.12511L5.4136 8.43989C5.15079 8.3205 4.84921 8.3205 4.5864 8.43989L3.07802 9.12511C2.37104 9.44627 1.58374 8.87426 1.67071 8.10264L1.85628 6.45634C1.88861 6.1695 1.79542 5.88268 1.60066 5.66963L0.48286 4.44682C-0.0410503 3.87369 0.259676 2.94815 1.02041 2.79243L2.64348 2.46018C2.92627 2.40229 3.17025 2.22503 3.31269 1.97396L4.13024 0.533001Z" fill="#A4BCE6"/>
                                            ...
                                            <span class="review-status text-xs text-[#2B313B] font-bold ml-2">3</span>
                                        </div>
                                            <span class="total-review text-[10px] text[#6C7A93] font-normal">(10089 Reviews)</span>
                                            </td>
                                        <td class="py-4 pr-3">
                    ...
                    <div class="grid grid-cols-2 gap-12">
                        <div class="product-detail-text">
                            ...
                            <p class="text-[#6C7A93] text-base font-normal leading-6 mb-5">Experience Nintendo games with nintendo switch OLED on a bigger screen with even more intense colors. The 7-inch OLED screen is larger than that of the regular Switch. With OLED, the colors appear richer and the contrast on the screen is higher. Plus, the Nintendo Switch OLED has a wide, adjustable stand that allows you to easily place the console on a table or desk. The Switch OLED also has a new mount with a LAN connection for a stable online experience.</p>
                                <p class="text-[#6C7A93] text-base font-normal leading-6">
This way, your online gaming session will not be interrupted by Wi-Fi failure. With 64GB of system memory, you can store more game updates and back up games from your game collection. Built-in speakers with enhanced audio for handheld and tabletop modes mean you don't need headphones for a relaxed gaming evening. Do you want to play with headphones? Simply connect it via the 3.5 millimeter audio port or wirelessly via Bluetooth. As with the Nintendo Switch, the Nintendo Switch allows you to play OLED on the TV and share the Joy-Con controllers to play together.</p>
                        </div>
                        ...
                        <div class="notification-form">
                            ...
                            <form action="https://bereken.webonedevs.com/internet-package" method="post" class="flex flex-col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="flex">
                                            <input type="text" name="name" class="rounded-[5px] bg-white border border-[#A4BCE6] text-[#6C7A93] font-normal text-xs  focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5" placeholder="Name">
                                        </div>
                                    
                                </div>
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-sm  font-normal text-black">Price lower than</label>
                                    <div class="flex">
                                            <input type="text" name="price" class="rounded-[5px] bg-white border border-[#A4BCE6] text-[#6C7A93] font-normal text-xs  focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5" placeholder="$250">
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="flex">
                                            <input type="email" name="email" class="rounded-[5px] bg-white border border-[#A4BCE6] text-[#6C7A93] font-normal text-xs  focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5" placeholder="$250">
                                        </div>
                                ...
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-sm  font-normal text-black">Email Address</label>
                                    <div class="flex">
                                            <input type="email" name="email" class="rounded-[5px] bg-white border border-[#A4BCE6] text-[#6C7A93] font-normal text-xs  focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5" placeholder="Email Address">
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="flex">
                                            <input type="text" name="phone" class="rounded-[5px] bg-white border border-[#A4BCE6] text-[#6C7A93] font-normal text-xs  focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5" placeholder="Phone Number">
                                        </div>
                                    
                                </div>
                                    <button type="submit" class="p-3 text-center outline-btn btn-translate-z bg-[#112954] text-white w-full text-sm  font-bold rounded-[5px]">Get Notifcation</button>
