...
<template>
        ...
        <div class="filter-wrapper flex flex-col lg:flex-row items-start lg:items-center justify-between">
            <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full lg:w-auto">
                <div class="flex items-center justify-between w-full lg:w-auto mr-0 lg:mr-4">
                    ...
                    <form action="" class="text-left w-full lg:w-28  ml-4">
                        <div class="">
                            <div class="no-label w-full lg:w-28">
            ...
            <div class="btn-area my-3 w-full md:w-auto lg:my-0">
                <NuxtLink to="/category-details/top-ten" class="flex items-center justify-center text-[#fff] text-xs font-bold bg-[#EF8421]  w-full md:w-auto transition hover:bg-[#d2751e] px-3 py-2 mr-4 md:mr-10 rounded-md">
                <svg
    ...
    <div class="center mt-8 grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-4 justify-between">
                <div class="item">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M0.366211 7.99993C1.38561 4.75423 4.41785 2.3999 7.99998 2.3999C11.5821 2.3999 14.6143 4.75421 15.6337 7.99987C14.6143 11.2456 11.5821 13.5999 7.99996 13.5999C4.41786 13.5999 1.38563 11.2456 0.366211 7.99993ZM11.2 7.9999C11.2 9.76721 9.76732 11.1999 8.00001 11.1999C6.2327 11.1999 4.80001 9.76721 4.80001 7.9999C4.80001 6.23259 6.2327 4.7999 8.00001 4.7999C9.76732 4.7999 11.2 6.23259 11.2 7.9999Z" fill="#112954"/>
            ...
            <div class="load-more-btn text-center">
                <button class="view-icon py-2.5 px-2.5 mt-8 border transition-all border-[#112954] text-[#112954] rounded-md w-32 hover:text-white">Show More</button>
            </div>
</template>