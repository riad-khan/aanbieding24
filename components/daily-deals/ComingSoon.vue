<template>
    <div class="heading-area mt-6 mb-4">
        <h2 class="flex items-center text-[#2B313B] font-bold text-[20px] mb-1">Coming Soon</h2>
        <p class="tag-line text-[#6C7A93] text-sm font-normal">View all Loungeset Products</p>
    </div>
   
            <div class="coming-soon center grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-4 justify-items-stretch">
        <div class="item">
            <a href="#"
