...
@media only screen and (max-width: 768px) {
    .product-table-wrapper thead.table-head {
    display: none;
}

.product-table-wrapper  tbody.table-body tr td:first-child {
    display: none;
}

.product-table-wrapper tbody.table-body tr td:nth-child(2) {
    display: block;
    width: 100%;
    font-weight: 700;
}

.product-table-wrapper .single-row-item {
    display: block;
}

.product-table-wrapper tbody.table-body tr td:nth-child(3) {
    color: #6C7A93;
    margin-bottom: 8px;
    display: block;
}

td.product-info-modal {
    display: block;
    width: 100%;
}

td.product-info-modal  a {
    width: 100%;
    margin-top: 6px;
}
...
<template>
  ...
  <tbody class="table-body">
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">01</td>
        ...
        <td class="rating-info hidden md:table-cell">
            <span class="rating-area flex items-top justify-start">
                <span class="icon mr-1">
                    <svg width="14" height="13" viewBox="0 0 14 13" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">02</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">03</td>
        <td class="text-[#2B313B] text-sm font-normal">Kees Smith</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">04</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">05</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">06</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">07</td>
        <td class="text-[#2B313B] text-sm font-normal">Wehkamp Hotels</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">08</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">09</td>
        <td class="text-[#2B313B] text-sm font-normal">Van der Garde</td>
    ...
    <tr class="single-row-item text-left p-4 w-full">
        <td class="text-[#2B313B] text-sm font-normal p-4">10</td>
        <td class="text-[#2B313B] text-sm font-normal">fonq</td>
        <td class="text-[#2B313B] text-sm font-normal">Delta lounge dining set - 6 pieces - Organic</td>
        <td class="price-info flex flex-row items-start w-full md:w-auto  justify-between md:justify-start md:flex-col">
