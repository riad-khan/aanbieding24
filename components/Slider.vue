                        ...
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/01.png" alt="image">
                            </div>
                ...
                <div class="items">
                    <a href="#"
                        ...
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/02.png" alt="image">
                            </div>
                            <div class="brand-logo">
                        ...
                        <div class="product-info mt-2 flex items-center justify-between">
                            <span class="w-fit bg-[#EBF1FF] text-[#0052FE] text-xs font-bold p-2 rounded ">Computer &
                                Laptop</span>
                ...
                <div class="items">
                    <a href="#"
                        ...
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/03.png" alt="image">
                            </div>
                            <div class="brand-logo">
                        ...
                        <div class="product-info mt-2 flex items-center justify-between">
                            <span class="w-fit bg-[#EBF1FF] text-[#0052FE] text-xs font-bold p-2 rounded ">Gadget &
                                Tablet</span>
                            <span class="product-status flex items-center text-[#1D9E54] font-normal text-xs"><img
                                    src="@/assets/img/icons/sell-arrow-green.svg" class="mr-1 w-4 h-4" alt="icon">
                                -24%</span>
                ...
                <div class="items">
                    <a href="#"
                        ...
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/04.png" alt="image">
                            </div>
                            <div class="brand-logo">
