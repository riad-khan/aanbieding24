...
<template>
  ...
  >
            <swiper-slide>
                <div class="items">
                    <a href="#"
                        class="flex  w-auto lg:w-[255px] mb-3 p-2 flex-col transition-all border border-[#EBF1FF]  rounded-lg hover:shadow-md md:flex-col  bg-white">
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/nintendo-switch-01.png" alt="image">
                            </div>
                        ...
                        <div class="product-info mt-2 flex items-center justify-between">
                            <span class="w-fit bg-[#EBF1FF] text-[#0052FE] text-xs font-bold p-2 rounded ">Electronics</span>
                        ...
                        <div class="product-title mt-2">
                            <h4 class="mb-2 text-base font-bold  text-[#2B313B]">Nintendo Switch Red/Blue</h4>
                        </div>
                ...
                <div class="items">
                    <a href="#"
                        ...
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/nintendo-switch-02.png" alt="image">
                            </div>
                            <div class="brand-logo">
                                <img src="@/assets/img/providers/amazon-brand.png" alt="icon">
                            </div>
                        ...
                        <div class="product-title mt-2">
                            <h4 class="mb-2 text-base font-bold  text-[#2B313B]">Nintendo Switch Grey</h4>
                        </div>
                        <div class="product-price-info flex items-center justify-between">
                            <div class="flex items-center justify-start">
                                <span class="text-[#2B313B] text-[8px] font-bold mr-1">Start from</span>
                                <span class="price text-[#F22222] text-base font-black ">$679</span>
                            </div>
                ...
                <div class="items">
                    <a href="#"
                        ...
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/nintendo-switch-03.png" alt="image">
                            </div>
                            <div class="brand-logo">
                                <img src="@/assets/img/providers/cool_blue.png" alt="icon">
                            </div>
                        </div>
                        <div class="product-info mt-2 flex items-center justify-between">
                            <span class="w-fit bg-[#EBF1FF] text-[#0052FE] text-xs font-bold p-2 rounded ">Electronics</span>
                        ...
                        <div class="product-title mt-2">
                            <h4 class="mb-2 text-base font-bold  text-[#2B313B]">Game on the Go Pack</h4>
                        </div>
                        <div class="product-price-info flex items-center justify-between">
                            <div class="flex items-center justify-start">
                                <span class="text-[#2B313B] text-[8px] font-bold mr-1">Start from</span>
                                <span class="price text-[#F22222] text-base font-black ">$278</span>
                            </div>
                            <!-- <span class="original-price line-through text-[#D3D7DE] text-xs font-normal">$390</span> <span class="saved-price bg-[#26BA65] text-white text-xs font-normal p-1 rounded">Saves €45.00</span>  -->
                            <span class="rating-area flex items-top justify-between"><span class="icon mr-1"><svg width="14"
                                        height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="items">
                    <a href="#"
                        ...
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/nintendo-switch-04.png" alt="image">
                            </div>
                            <div class="brand-logo">
                                <img src="@/assets/img/providers/amazon-brand.png" alt="icon">
                            </div>
                        ...
                        <div class="product-title mt-2">
                            <h4 class="mb-2 text-base font-bold text-[#2B313B]">Nintendo Switch (2019 Upgrade)</h4>
                        </div>
                        <div class="product-price-info flex items-center justify-between">
                            <div class="flex items-center justify-start">
                                <span class="text-[#2B313B] text-[8px] font-bold mr-1">Start from</span>
                                <span class="price text-[#F22222] text-base font-black ">$259</span>
                            </div>
                            <!-- <span class="original-price line-through text-[#D3D7DE] text-xs font-normal">$390</span> <span class="saved-price bg-[#26BA65] text-white text-xs font-normal p-1 rounded">Saves €45.00</span>  -->
                            <span class="rating-area flex items-top justify-between"><span class="icon mr-1"><svg width="14"
                                        height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <swiper-slide>
                <div class="items">
                    <a href="#"  class="flex w-auto lg:w-[255px] mb-3 p-2 flex-col transition-all border border-[#EBF1FF]  rounded-lg hover:shadow-md md:flex-col  bg-white">
                        <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                            <div class="product-img">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/products/nintendo-switch-03.png" alt="image">
